...
// Images: Unsplash (public, CSP-allowed)
// Design system: #0d0d0d bg · #c5a059 gold · #161616 surface · #a5a5a5 secondary
// Fonts: Playfair Display · Source Serif 4 · Montserrat
    ...
    <div className="bg-[#0d0d0d] text-[#f2f0f0]" style={{ fontFamily: 'var(--font-source-serif), serif' }}>
      ...
      <section className="relative flex items-center overflow-hidden" style={{ minHeight: '85vh' }}>
        <img
          ...
          src="https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=1920&q=80&fit=crop"
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, #0d0d0d 0%, rgba(13,13,13,0.15) 60%, transparent 100%)' }} />
        <div className="relative z-10 px-6 w-full max-w-2xl mx-auto mt-20 pb-12">
          <p className="text-[#c5a059] uppercase text-[10px] tracking-[0.4em] mb-5"
          ...
          <p className="text-[#a5a5a5] text-sm leading-relaxed mb-8 max-w-md">
          ...
          <div className="flex flex-col gap-4 max-w-sm">
            <Link
              href="/rfq"
              className="block text-center py-5 text-[#131313] text-[10px] uppercase tracking-[0.2em] font-bold"
            ...
            <p className="text-[10px] text-[#a5a5a5] uppercase tracking-widest text-center"
      ...
      {/* ── Trust Banner ─────────────────────────────────────────────────── */}
      <section className="py-8 bg-[#161616] border-y border-[#3a3a3a]/30">
        <div className="max-w-2xl mx-auto px-6 flex flex-col items-center text-center gap-4">
          <div className="flex items-center gap-2 text-[#c5a059] text-[10px] uppercase tracking-widest"
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 opacity-60">
            {['Equipa certificada ISO 9001', 'Parceiros internacionais verificados', 'Mockup gratuito em 24h'].map(t => (
              <span key={t} className="text-[8px] uppercase tracking-tighter"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>{t}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#0d0d0d]">
        <div className="max-w-2xl mx-auto px-6 grid grid-cols-2 gap-y-10">
          {[
            ...
            <div key={stat.label} className="text-center">
              <p className="text-3xl text-[#c5a059] mb-1"
                style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>{stat.value}</p>
              <p className="text-[9px] text-[#a5a5a5] uppercase tracking-widest"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-12 bg-[#161616]">
        <div className="max-w-2xl mx-auto px-6 mb-8">
          <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Categorias</span>
          <h3 className="text-2xl mt-2" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>Explora o Catálogo</h3>
        </div>
        <div className="flex overflow-x-auto gap-6 px-6 pb-4" style={{ scrollbarWidth: 'none' }}>
          <div className="max-w-2xl mx-auto flex gap-6 pb-2">
            {[
              ...
              <Link key={cat.label} href={cat.href} className="flex-shrink-0 flex flex-col items-center gap-3">
                ...
                <span className="text-[9px] uppercase tracking-widest"
                  style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>{cat.label}</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* ── Marquee ──────────────────────────────────────────────────────── */}
      <section className="py-10 bg-[#0d0d0d] overflow-hidden border-y border-[#3a3a3a]/20">
        <p className="text-center text-[9px] text-[#a5a5a5] uppercase tracking-[0.3em] mb-8"
          style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>
        ...
        <div className="relative flex overflow-x-hidden">
          ...
          >
            {['GALP','EDP','SONAE','NOS','KPMG','TAP','MILLENNIUM BCP','SANTANDER',
              ...
              <span key={i} className="text-xl px-4"
                style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>{name}</span>
            ))}
          </div>
        </div>
        <style>{`
      ...
      <section className="py-20">
        <div className="max-w-2xl mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Curadoria Premium</span>
              <h3 className="text-3xl mt-2" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>Coleção Curada</h3>
            </div>
            <Link href="/catalog" className="text-[10px] text-[#a5a5a5] border-b border-[#a5a5a5] pb-1"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>TODOS</Link>
          </div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-12">
            {[
              {
                img: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&q=80&fit=crop',
                badge: 'POPULAR', badgeClass: 'bg-[#c5a059]/90 text-[#131313]',
                name: 'Premium Leather Journal', price: 'A partir de €12 /un · MOQ 50'
              },
              {
                img: 'https://images.unsplash.com/photo-1612528443702-f6741f70a049?w=600&q=80&fit=crop',
                badge: 'ECO', badgeClass: 'bg-green-900/90 text-white',
                name: 'Insulated Tumbler 500ml', price: 'A partir de €18 /un · MOQ 100'
              },
              {
                img: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=600&q=80&fit=crop',
              ...
              <div key={product.name}>
                <div className="relative mb-4 overflow-hidden border border-[#3a3a3a]/20"
                  style={{ aspectRatio: '4/5', background: '#161616' }}>
                  <img
                    className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                    src={product.img} alt={product.name}
                  />
                  <div className={`absolute top-2 left-2 ${product.badgeClass} px-2 py-1 text-[8px] tracking-widest`}
                    style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>
                    {product.badge}
                  </div>
                </div>
                <h4 className="text-sm mb-1"
                  style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 600 }}>{product.name}</h4>
                <p className="text-[10px] text-[#a5a5a5]">{product.price}</p>
              </div>
            ))}
          </div>
          <Link href="/catalog"
            className="block w-full mt-12 py-5 border border-[#c5a059] text-[#c5a059] text-center text-[10px] uppercase tracking-widest"
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>
      ...
      <section className="py-24 bg-[#161616]">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.4em]"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>A Mudança</span>
          ...
          <div className="space-y-6">
            <div className="p-8 border border-[#ffb4ab]/20 bg-[#0d0d0d]/50">
              ...
              <ul className="space-y-3 text-[#a5a5a5] text-xs leading-relaxed">
            ...
            <div className="p-8 border border-[#c5a059]/30" style={{ background: 'rgba(197,160,89,0.05)' }}>
              ...
              <ul className="space-y-3 text-[#f2f0f0] text-xs leading-relaxed">
      ...
      <section className="py-24 bg-[#0d0d0d] overflow-hidden">
        <div className="max-w-2xl mx-auto px-6 mb-12">
          <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Resultados Reais</span>
        ...
        <div className="flex overflow-x-auto gap-6 px-6 pb-8" style={{ scrollbarWidth: 'none' }}>
          {[
            ...
            { q: '"Para o nosso evento de fim de ano com 800 convidados, a yourgift.pt entregou 800 gift boxes premium dentro do prazo."', name: 'Rui Alves', role: 'Events & Sponsorship · Millennium BCP' },
          ].map((t) => (
            <div key={t.name} className="flex-shrink-0 w-80 p-8 bg-[#161616] border border-[#3a3a3a]/30">
              <span className="material-symbols-outlined text-[#c5a059] block mb-6" style={{ fontSize: '2.5rem' }}>format_quote</span>
              <p className="text-sm italic mb-8 leading-relaxed">{t.q}</p>
              <div>
                <p className="text-[#c5a059]" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 600 }}>{t.name}</p>
                <p className="text-[9px] text-[#a5a5a5] uppercase tracking-widest mt-1"
                  style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>{t.role}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-24 bg-[#161616]">
        <div className="max-w-2xl mx-auto px-6">
          <div className="mb-16">
            <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Ecossistema</span>
            <h3 className="text-3xl mt-2" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>
      ...
      <section className="py-24 bg-[#0d0d0d]">
        <div className="max-w-2xl mx-auto px-6">
          <div className="bg-[#161616] p-10 border border-[#3a3a3a]/30 relative overflow-hidden">
            <span className="material-symbols-outlined absolute top-4 right-4 text-[#f2f0f0] opacity-5"
              style={{ fontSize: '6rem' }}>store</span>
            <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Inovação B2B</span>
            <h3 className="text-2xl mt-4 mb-8" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>
              A loja privada da tua empresa.
            </h3>
            <ul className="space-y-5 text-xs leading-relaxed text-[#a5a5a5]">
              {[
                ...
                <li key={item.strong} className="flex gap-4">
                  <span className="material-symbols-outlined text-[#c5a059] flex-shrink-0" style={{ fontSize: '1rem' }}>check_circle</span>
      ...
      <section className="py-24 bg-[#161616]">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.4em]"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Investimento</span>
            <h3 className="text-3xl mt-4" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>
              Preços que fazem sentido para empresas
            </h3>
          </div>
          <div className="space-y-8">
            {[
              {
                tier: 'STARTER', price: '€500 – €2.500',
                desc: 'Ideal para Startups, PMEs, primeiros projetos de branding',
                features: ['Até 50 unidades por projeto', 'Mockup digital incluído', 'Resposta em 48h garantida'],
                featured: false
              },
              {
                tier: 'GROWTH', price: '€2.500 – €10.000',
                desc: 'Empresas de 50–500 colaboradores com projetos recorrentes',
                features: ['Múltiplos produtos por projeto', 'Gestor dedicado incluído', 'Store privada opcional'],
                featured: true
              },
              {
                tier: 'ENTERPRISE', price: '€10.000+',
                desc: 'Grandes empresas, grupos e multinacionais em Portugal',
                features: ['Fulfillment e gestão de stock', 'Integrações API/ERP', 'Account manager sénior'],
                featured: false
              },
            ].map((plan) => (
              <div key={plan.tier}
                className={`p-8 relative ${plan.featured ? 'border-2 border-[#c5a059] bg-[#0d0d0d]' : 'border border-[#3a3a3a]/30 bg-[#0d0d0d]/50'}`}>
                {plan.featured && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#c5a059] text-[#131313] px-4 py-1 text-[8px] tracking-widest"
                    style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 700 }}>
                    MAIS ESCOLHIDO
                  </div>
                )}
                <p className="text-[9px] text-[#c5a059] tracking-[0.2em] mb-3"
                  style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>{plan.tier}</p>
                <p className="text-2xl mb-2" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>{plan.price}</p>
                <p className="text-[#a5a5a5] text-[10px] mb-6">{plan.desc}</p>
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-center gap-3 text-[11px] text-[#a5a5a5]">
                      <span className="material-symbols-outlined text-[#c5a059]" style={{ fontSize: '1rem' }}>check</span>
                      {f}
                    </li>
                  ))}
                </ul>
                <Link href="/rfq"
                  className="block w-full py-4 text-center text-[9px] uppercase tracking-widest"
                  style={{
                    ...(plan.featured
                      ? { background: 'linear-gradient(135deg, #c5a059 0%, #e9c176 100%)', color: '#131313' }
      ...
      <section className="py-24 bg-[#0d0d0d]">
        <div className="max-w-2xl mx-auto px-6">
          <div className="mb-12">
            <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.3em]"
              style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Dúvidas</span>
            <h3 className="text-3xl mt-3" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>
              Perguntas Frequentes
            </h3>
          </div>
          <div className="space-y-6">
            {[
              { q: 'Qual é o prazo médio de produção?', a: 'A maioria dos projetos fica entre 10 e 20 dias úteis após aprovação do mockup. Projetos urgentes podem ser acelerados.' },
              { q: 'Qual é o pedido mínimo (MOQ)?', a: 'O MOQ começa geralmente nas 20-50 unidades para produtos premium de secretária ou apparel.' },
              { q: 'Fazem envio internacional?', a: 'Sim, entregamos em mais de 15 países na Europa e mercados globais, com gestão completa de alfândega.' },
              { q: 'Como funciona a personalização?', a: 'Trabalhamos com serigrafia, bordado, laser e impressão UV. O nosso gestor sugere a técnica ideal para o teu produto.' },
            ].map((item) => (
              <details key={item.q} className="group border-b border-[#3a3a3a]/20 pb-6">
                <summary className="flex justify-between items-center cursor-pointer list-none py-2">
                  <span className="text-sm pr-4" style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 600 }}>{item.q}</span>
                  <span className="material-symbols-outlined text-[#c5a059] flex-shrink-0 transition-transform group-open:rotate-180">
                    expand_more
                  </span>
                </summary>
      ...
      {/* ── Final CTA ────────────────────────────────────────────────────── */}
      <section className="py-28 bg-[#161616] text-center border-t border-[#3a3a3a]/30">
        <div className="max-w-2xl mx-auto px-6">
          <span className="text-[10px] text-[#c5a059] uppercase tracking-[0.4em]"
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600 }}>Prontos para começar?</span>
          <h3 className="text-3xl mt-6 mb-10"
            style={{ fontFamily: 'var(--font-playfair), serif', fontWeight: 700 }}>
            A tua marca merece mais do que merch genérico.
          </h3>
          <Link href="/rfq"
            className="block w-full py-6 text-center text-[#131313] text-[11px] uppercase tracking-[0.2em]"
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
            {[
              { icon: 'verified_user', text: '30 Dias de Satisfação Garantida' },
              { icon: 'history_edu', text: 'Resposta em 48h por Contrato' },
            ].map(item => (
              <div key={item.text} className="flex items-center justify-center gap-3 text-[9px] text-[#a5a5a5] uppercase tracking-widest"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>
                <span className="material-symbols-outlined text-[#c5a059]" style={{ fontSize: '1rem' }}>{item.icon}</span>
                {item.text}
              </div>
            ))}
          </div>
      ...
      {/* ── Mobile Bottom Nav ────────────────────────────────────────────── */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-sm rounded-full z-50 border border-[#3a3a3a]/30 md:hidden"
        ...
        <div className="flex justify-around items-center py-3">
          {[
            ...
            <Link key={item.label} href={item.href}
              className="flex flex-col items-center gap-1 text-[#a5a5a5] first:text-[#c5a059]">
              <span className="material-symbols-outlined" style={{ fontSize: '1.4rem' }}>{item.icon}</span>
              <span className="text-[7px] tracking-wider uppercase"
                style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>{item.label}</span>
            </Link>
          ))}
        </div>
      </div>
