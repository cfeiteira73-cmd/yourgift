...
const STATUS: Record<string, { label: string; color: string; bg: string }> = {
  ...
  proposed: { label: 'Proposta enviada',color: '#d4b47a', bg: 'rgba(154,124,74,0.12)' },
  ...
  expired:  { label: 'Expirado',  color: 'rgba(240,236,228,0.42)', bg: 'rgba(120,130,150,0.08)' },
};
      ...
      <div style={{ padding: '1.5rem 2rem 3rem', maxWidth: '860px' }}>
        ...
        {loading ? (
          ...
          <div style={{ padding: '3rem', textAlign: 'center', color: 'rgba(240,236,228,0.28)' }}>
            ...
            <button type="button" onClick={() => setShowForm(true)} style={{ fontSize: '0.75rem', color: '#d4b47a', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'underline' }}>Pedir o primeiro agora</button>
          </div>
        ) : (
