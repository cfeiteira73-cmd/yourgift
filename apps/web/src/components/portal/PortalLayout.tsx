...
const ICONS = {
  ...
  ops_center:   ['M13 10V3L4 14h7v7l9-11h-7z'],
  ...
  cs:           ['M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z'],
  security:     ['M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
  ecosystem:    ['M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9'],
  command:      ['M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z'],
  approvals:    ['M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z'],
...
const NAV_ITEMS = [
  ...
  { href: '/ops-center',    label: '⚡ Live Ops Center',    icon: 'ops_center' },
  ...
  { href: '/client-success',   label: 'Client Success',        icon: 'cs' },
  { href: '/security',         label: 'Security Engine',        icon: 'security' },
  { href: '/ecosystem',        label: 'Global Ecosystem',       icon: 'ecosystem' },
  { divider: 'Centro de Comando' },
  { href: '/command',          label: '⚡ Command Center',       icon: 'command' },
  { href: '/mobile',           label: 'Mobile Operations',      icon: 'mobile' },
  { divider: 'Compliance' },
  { href: '/approvals',        label: 'Approval Center',        icon: 'approvals' },
  ...
  { href: '/financials',       label: 'Intel Financeira',       icon: 'financials' },
