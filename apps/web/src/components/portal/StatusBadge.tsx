...
export const ORDER_STATUS_MAP: Record<string, StatusConfig> = {
  ...
  paid:              { label: 'Pago',          bg: 'rgba(154,124,74,0.12)',  text: '#d4b47a',    border: 'rgba(154,124,74,0.22)',  dot: '#d4b47a' },
  confirmed:         { label: 'Confirmado',    bg: 'rgba(154,124,74,0.12)',  text: '#d4b47a',    border: 'rgba(154,124,74,0.22)',  dot: '#d4b47a' },
  payment_confirmed: { label: 'Pago',          bg: 'rgba(154,124,74,0.12)',  text: '#d4b47a',    border: 'rgba(154,124,74,0.22)',  dot: '#d4b47a' },
  ...
  shipped:           { label: 'Enviada',       bg: 'rgba(154,124,74,0.12)', text: '#b8975e',   border: 'rgba(184,151,94,0.18)',  dot: '#b8975e' },
...
export const QUOTE_STATUS_MAP: Record<string, StatusConfig> = {
  ...
  submitted: { label: 'Submetido',   bg: 'rgba(154,124,74,0.12)',  text: '#d4b47a',   border: 'rgba(154,124,74,0.22)', dot: '#d4b47a' },
  ...
  converted: { label: 'Convertido',  bg: 'rgba(154,124,74,0.12)', text: '#b8975e',  border: 'rgba(184,151,94,0.18)', dot: '#b8975e' },
};
