# S3 for static assets and artwork uploads
...
# CORS configuration for artwork uploads from the web/admin frontends
...
# Lifecycle rule: move older artwork originals to cheaper storage
